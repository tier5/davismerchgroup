...
$sql = 'SELECT t.*,odo.*,store.sto_num as store_num_val,ch.chain FROM dtbl_timesheet as t left join dtbl_odometer as odo on odo.time_id=t.time_id'.
        ' left join "tbl_store" as store on store.sid=t.store_num'
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>                        
                        <td height="30"  align="left" valign="top" class="gridWhite"><?php echo $chain; ?></td>
                        <td align="left" valign="top" class="gridWhite"><?php echo $store_num_val; ?></td>
