...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <input style="display:none;" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" onclick="javascript:payRoll();" type="button" value="Payroll Report" />           
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
