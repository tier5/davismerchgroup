                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>                        
                        <td height="30"  align="left" valign="top" class="gridWhite"><?php if($store==0) { echo $others; } else echo $chain; ?></td>
                        <td align="left" valign="top" class="gridWhite"><?php if($store==0) { echo $store_num; } else echo $store_num_val; ?></td>
