...
/*****************************************************************************
*
* FILENAME     :CommonUtilities.inc.php
* VERSION      :1.0
...
* SPECIFICATION:
*
* REMARKS      : This is the utility Class
*
****************************************************************************
* HISTORY      :
*
*			  Name and Department: 
*             Modification date  :30-January-2007
*             Description        : Created
*Created By	   : Sreejith K
*Created On    : 20-January-2007
*Modified On   : 30-January-2006
*
****************************************************************************/
	...
	public function Pagination( $strURl, $totaljobs, $strQueryString, $limit ) {
		...
		for ($k=$k;$k<=$ParentCount;$k++) {
			...
			if ($_GET['Index'] > 0) {
				...
				print "<td><a href='$strURl{$strQuQsAppend}Start=$intPreviousNumber&Index=$index'><img src='first.gif' border='0' alt='Previous $limit Pages' /></a></td>";
			}
			if ($_GET["Start"]!=1 & isset($_GET["Start"])) {
				...
				print "<td><a href='$strURl{$strQuQsAppend}Start=$intPrevValue&Index=$intPrevIndex'><img src='previous.gif' border='0' alt='Previous Page' /></a></td>";
			}
			...
			if (isset($ParentArr[$intNextIndex][0])) {
				...
				print "<td><a href='$strURl{$strQuQsAppend}Start=$StartValue&Index=$intNextIndex'><img src='next.gif' border='0' alt='Next Page' /></a></td>";
			}
			...
			if (isset($ParentArr[$getLastIndex])) {
				...
				print "<td><a href='$strURl{$strQuQsAppend}Start=$intNextNumber&Index=$getLastIndex'><img src='last.gif' border='0' alt='Next $limit Pages' /></a></td>";
			}
			break;
		}
		echo "</tr></table>";
