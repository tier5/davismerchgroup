...
function getEDTable($aryField,$ary2Value)//if not $ahref=100
	{	
			...
			{
				$str.= "<td height=25 class=gridHDR>$aryField[$h]</td>";
			}
			$str.= "</tr>";
		
			for($i=0;$i<count($ary2Value);$i++)
			{$str.= "<tr>";
				$str.= "<td height=25 class=grid001>".$ary2Value[$i][1]."</td>";
				$str.= "<td height=25 class=grid001>".$ary2Value[$i][2]."</td>";
				$str.= "<td height=25 class=grid001>".$ary2Value[$i][3]."</td>";
				$str.= "<td height=25 class=grid001><a href=editApplication.php?iid=".$ary2Value[$i][0]."><img src=\"../../images/listviewEdit.png\" width=32 height=32></a></td>";	
				$str.= "<td height=25 class=grid001><a href=deleteApplication.php?iid=".$ary2Value[$i][0]."><img src=\"../../images/1277880471_close.png\" width=32 height=32></a></td>";
				$str.= "</tr>";	
			}
