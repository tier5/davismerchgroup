...
<center>
              ...
              <td>   <input class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="button" name="print" id="print" value="Print">
  &nbsp;<input class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="button" name="print_all" id="print_all" value="Print All">
</td>
     ...
     <form id="feedbackform" name="feedbackform" method="post" style="width:765px;">
...
jQuery.ajax({
  url: 'printApplication.php?iid=<?php echo$_GET['iid'] ?>',
  success: function(data) {
    jQuery("#print_content").html(data); 	
  }
});
...
var printSelection = function (){
  var content=jQuery("#print_content").html(); 
var pwin=window.open("",'Print Employee Application','width=900,height=400');
  pwin.document.open();
  pwin.document.write('<html><head><style type="text/css"> .grid001{background-image:url(<?php echo $mydirectory; ?>/images/headerbg.jpg);font-family:Tahoma, Verdana, Arial, Helvetica;color:#000033;font-size:12px;font-weight:bold; padding-top:10px; padding-left:10px;}  .gridVal{background: url("<?php echo $mydirectory; ?>/css/images/ui-bg_highlight-hard_100_f2f5f7_1x100.png") repeat-x scroll 50% top #F2F5F7;height:25px;border: 1px solid #DDDDDD;font-family:Tahoma, Verdana, Arial, Helvetica;font-size:12px;color: #362B36;} </style></head><body onload="window.print()"><table><tr><td>&nbsp;&nbsp;&nbsp;</td><td>' +content+'</td></tr></table></body></html>');
  pwin.document.close(); 
...
printAllTab();	
 ...
 var printAllTab = function (){
    //alert(jQuery("#print_content").html());
    var content="";  
    jQuery(".sectionwrap").each(function(){
      content+=jQuery(this).html();      
    });

var pwin=window.open("",'Print Employee Application','width=900,height=400');
  pwin.document.open();
  pwin.document.write('<html><head><style type="text/css"> .grid001{background-image:url(<?php echo $mydirectory; ?>/images/headerbg.jpg);font-family:Tahoma, Verdana, Arial, Helvetica;color:#000033;font-size:12px;font-weight:bold; padding-top:10px; padding-left:10px;}  .gridVal{background: url("<?php echo $mydirectory; ?>/css/images/ui-bg_highlight-hard_100_f2f5f7_1x100.png") repeat-x scroll 50% top #F2F5F7;height:25px;border: 1px solid #DDDDDD;font-family:Tahoma, Verdana, Arial, Helvetica;font-size:12px;color: #362B36;} </style></head><body onload="window.print()">' +content+'</body></html>');
  pwin.document.close(); 
  setTimeout(function(){pwin.close();},1000);
}
   </script>
