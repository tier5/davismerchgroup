...
echo "<br><br>";
echo "<center>";
echo "<a href=\"addemp.php\">Add User</a> | ";
echo "<a href=\"editemp0.php\">Edit User</a> | ";
...
echo "<p>";
echo "<a href=\"project_add/project_list.php\">Add/Edit Projects</a>";
echo "<p>";
echo "<p>";
echo "<a href=\"chain/list_chain.php\">Add/Edit Chain Category</a>";
echo "<p>";
echo "<a href=\"chain_new/chain_new_list.php\">Add/Edit Chain Management</a>";
echo "<p>";
echo "<a href=\"region/region_list.php\">Add/Edit Region</a>";
echo "<p>";
echo "<a href=\"announcement/index.php\">Add/Edit Announcement</a>";
require('../trailer.php');
?>
