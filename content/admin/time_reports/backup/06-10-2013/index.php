...
$sql="Select t.time_id,t.store,ch.chain as ch, t.start_time, t.end_time, t.hours_worked,t.lunch_hrs, t.reg_hours, t.ot_hours, t.status, e.firstname as f, e.lastname as l,reg.region as r,e.city as location, odo.daily_total, odo.reimburse_mile, odo.gas_rec, odo.misc_exp, odo.misc_exp_type from dtbl_timesheet t ".
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
		...
		foreach ($time as $t)
		{
			...
			echo '<td align="left" valign="top" class="gridVal">'.$t['ch'].'</td>';
                        echo '<td align="left" valign="top" class="gridVal">'.$t['location'].'</td>';
