...
$sql = 'SELECT * FROM "tbl_store" ORDER BY sid DESC';
//echo $sql;
            ...
            <tr>
                <td align="center" valign="top"><font size="5"><br>
                    <table border="0" width="20%">
                        <tr>
                            <td align="center"><input type="button" onmouseover="this.style.cursor = 'pointer';" value="Add/Edit Store" onclick="location.href='add_store.php';" /></td>
<!--<td align="center"><input type="button" value="Generate Spreadsheet" onmouseover="this.style.cursor = 'pointer';" onclick="javascript:spreadsheet();" style="cursor: pointer;"></td>-->   
                    ...
                    <table width="70%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                              <td class="grid001">Store Name</td> 
                        	<td class="grid001">Store#</td> 
                            <td class="grid001">Address1</td> 
                            <td class="grid001">Address2</td>
        ...
        <?php
			  ...
			  ?>
                                <tr>
                                    <td class="gridVal"><?php echo $datalist[$i]['sto_name'];?></td>
                                    <td class="gridVal"><?php echo $datalist[$i]['sto_num'];?></td>
                                   <td class="gridVal"><?php echo $datalist[$i]['address'];?></td>
                                   <td class="gridVal"><?php echo $datalist[$i]['address2'];?></td>
