...
$sql = 'SELECT str.*,chain.chain FROM "tbl_store" as str left join tbl_chain as chain on chain.ch_id=str.sto_name '. $where.' ORDER BY sid DESC';
/*if($where!="")
    $sql.= $where;*/
//echo $sql;
...
data="";
 ...
 if($.trim($("#ch_name").val())!="")
    ...
    if(data!="")
    location.href='store_list.php'+data;
else
