...
$queryp=("INSERT INTO \"permissions\" ".
		 "(\"accounting\", \"admin\", \"humanresources\", \"directory\", \"calendar\", \"operations\", \"sales\", \"support\", \"production\", \"purchasing\", \"external\", \"timesheet\", \"employee\", \"login\") ".
		 "VALUES ".
		 "('$accounting', '$admin', '$humanresources', '$directory', '$calendar', '$operations', '$sales', '$support', '$production', '$purchasing', '$external', '$timesheet', '$empid', '$login')");
