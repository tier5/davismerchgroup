...
$tmp=$form_type;
 ...
 {}else{ ?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="30">Picture (only if the store is not on the smoke fish list): </td>
      <td>&nbsp;</td>
      <td><input  type="file" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" name="proj_smkfsh" id="proj_smkfsh" 
              onchange="javascript:formFileUpload('proj_smkfsh','I','proj_smkfsh_img', 960,720);"/></td>
      </tr>
  <tr> <td></td><td></td><td><br/>
                      <img width="100px" height="100px"  id="proj_smkfsh_img_field" src="<?php echo  $image_dir.$ralph['smkfsh_img'];?>"
                            onclick="PopEx(this, null,  null, 0, 0, 50,'PopBoxImageLarge');"/>
                      <input  type="hidden" id="proj_smkfsh_img" name="smkfsh_img" value="<?php echo $ralph['smkfsh_img'];?>"/></td>
  </tr>    
  </table>        
      </span> 
