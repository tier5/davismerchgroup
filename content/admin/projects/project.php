              ...
              success: function (data)
        {
            ...
            if(typeof(data.error) != 'undefined')
            {
                if(data.error != ''){
                    ...
                    show_msg('success',data.msg);if(typeof(data.html) != 'undefined' && data.html != ''){
                     if(form_type=='smoke_imgs') 
                         {
                $('#img_cnt_signoff_smoke').html(data.html);              
                         }
                         else{
                        $('#img_cnt_signoff_pop').html(data.html);}
