...
<table width="95%">
    <tr>
     ...
     onchange="javascript:ajaxFileUpload('101','I', 960,720);" /> <input type="hidden" name="img" id="img" value=""/>            
                    </td>             
                </tr>
            </table>
        </td>
...
<table width="95%">
  ...
  ?>
 <tr><td colspan="8" align="right"><div id="file_view"><img width="100" height="100" src="<?php echo $image_dir.$project['img_file'];?>"/>
       <input type="hidden" name="img" id="img" value="<?php echo $project['img_file'];?>"/>     
         </div></td></tr>  
</table>
