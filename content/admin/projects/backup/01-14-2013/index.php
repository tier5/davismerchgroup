...
<table>
 ...
 <td>Store Name:</td>
 <td><select name="st_name" id="st_name"> 
 <option value="">--------Select--------</option>                   
                    <?php
		...
		?>
             ...
             <td>&nbsp;</td>
     <td>Store Number:</td>
     <td><input type="text" size="20px" name="sto_num" id="sto_num" value="<?php echo $_GET['sto_num']; ?>" /></td>
            </tr>
            <tr>
            <td>Merchandiser:</td>
            ...
            <td>Start Time:</td>
            <td><input type="text" size="10px" name="time" id="time" value="<?php echo $_GET['time']; ?>" /></td>
            </tr>
 <tr>
     <td>Date From:</td>
...
if($('#merch_id_hdn').val()==0&&flag>0)
{
show_msg('error',"This Merchandiser is already selected...");
return;
}   
else if($('#merch_id_hdn').val()>0&&flag>=2)
{
show_msg('error',"This Merchandiser is already selected...");
return;
} 
