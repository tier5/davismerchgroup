...
if ($pid > 0)
{
    ...
    $merch_list=array();
   $sql = "SELECT merch.location,chain.chain,merch.m_id,str.sto_name,merch.store_num,merch.st_time,merch.cid,merch.merch,merch.notes, merch.address, merch.phone, merch.due_date,prj.prj_name as prjname, c.client, c.\"clientID\", m1.firstname as m1first, m1.lastname as m1last ";
