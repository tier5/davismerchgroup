...
<table>
 ...
 <tr>
     <td>Date From:</td>
     <td><input size="15px" type="text" name="date_from" id="date_from" readonly="readonly" value="<?php 
     if(isset($_GET['date_from'])&&$_GET['date_from']!="")
         echo $_GET['date_from'];
     ?>" /></td>
     <td>Date To:</td>
     <td><input size="15px" type="text" name="date_to" id="date_to" readonly="readonly" value="<?php 
 ...
 <td colspan="2" align="left"><input onclick="javascript:resetSearchPrjs();" type="button" value="Reset" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all"/></td></tr>
</table>
