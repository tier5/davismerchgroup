...
$sql = 'SELECT distinct prj.pid, prj.prj_name from "prj_merchants" as m left join projects as prj on prj.pid = (select mer.pid from prj_merchants as mer where mer.pid = m.pid  limit 1 )    '.$where ;
$total =countRec($sql);
$sql .= " $sort $limit";
