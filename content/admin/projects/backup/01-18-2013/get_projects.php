...
inner join prj_merchants as m on m.m_id = (select mer.m_id from prj_merchants as mer left join tbl_region as reg on reg.rid=mer.region '
.' left join tbl_chain as ch on ch.ch_id=mer.location left join tbl_store as st on st.sid = mer.store_num '
