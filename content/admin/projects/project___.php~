...
if ($pid > 0)
{
    ...
    $merch_list=array();
   $sql = "SELECT merch.location,chain.chain,merch.m_id,str.sto_name,merch.store_num,merch.st_time,merch.cid,merch.merch,merch.notes, merch.address, merch.phone, merch.city, merch.zip, merch.due_date,prj.prj_name as prjname, c.client, c.\"clientID\", m1.firstname as m1first, m1.lastname as m1last ";
                ...
                <table width="80%">
                  ...
                  echo '>' . $employee[$i]['firstname'] . ' ' . $employee[$i]['lastname'] . '</option>';
                    ...
                    <tr>
                        ...
                        <td><input type="text" readonly="readonly" name="address" id="address" value="<?php echo $merch_list[0]['address'];?>"   /></td>
