...
$sql = 'SELECT "employeeID" as id, firstname as f, lastname as l, company_rep FROM "employeeDB" WHERE active=\'yes\';';
if(!($result=pg_query($connection,$sql))){
  ...
  <tr>
    <td><fieldset><legend><strong style="font-size:14px;">Search</strong></legend><form accept-charset="utf-8" name="search_frm" id="search_frm" method="post" action="index.php"><table width="100%" border="0" cellspacing="0" cellpadding="0"  style="padding-left:20px;">
        <tr>
          ...
          <td width="10">&nbsp;</td>
          <td width="200"><select name="employee">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><input class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" onclick="javascript:summary();" type="button" value="View Summary Report" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
      ...
      <div style="height:30px;"><span style="float:left;"><input type="image" src="<?php echo $mydirectory.'/images/approved.png'; ?>" name="approve" /></span><span style="float:right;"><input type="image" src="<?php echo $mydirectory.'/images/reject.png'; ?>" name="reject" /></span></div></fieldset>
