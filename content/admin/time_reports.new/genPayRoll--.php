...
$sql = 'SELECT distinct e.*,t.*,odo.* FROM dtbl_timesheet as t left join "employeeDB" as e on e."employeeID" = t.emp_id left join dtbl_odometer as odo on odo.time_id=t.time_id';  
...
$emp_ls[$cnt]['wage']=$datalist[$i]['wage'];  
