...
$_SESSION['com_rep']=$dataapp1[0]['company_rep'];
$_SESSION['client_id']=$dataapp1[0]['client_Id'];
$_SESSION['emp_type']=$dataapp1[0]['emp_type'];
$client_id = $dataapp1[0]['client_Id'];
...
$queryapp=("SELECT \"ID\", \"employee\", \"admin\", \"accounting\", \"humanresources\", \"directory\", \"calendar\", \"production\", \"sales\", \"purchasing\", \"support\", \"operations\", \"external\", \"timesheet\",\"manager\", \"tracking\" ".
		 "FROM \"permissions\" ".
		 "WHERE \"employee\" = '$eid'");
...
$_SESSION['perm_timesheet']=$dataapp[0]['timesheet'];
$_SESSION['perm_manager']=$dataapp[0]['manager'];
$mileage_rate=0.405;
?>
