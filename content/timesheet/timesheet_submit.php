...
$sum = intval($odo_food*100) +  intval($odo_lodging*100) +  intval($odo_toll_fees*100) +  intval($odo_park_fees*100) + intval($odo_misc*100);
$odo_mis_exp= floatval($sum/100);
...
{
  $sql.=' and merch='.$employeeid;   
}
else{
  $sql.=' and merch='.$_SESSION['employeeID'];  
}
